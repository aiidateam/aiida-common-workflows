...
# -*- coding: utf-8 -*-
"""Launch script for the common relax work chain demonstrator using CP2K."""
from aiida import orm
from aiida.engine import run
from aiida.plugins import DataFactory

from aiida_common_workflows.workflows.relax.generator import RelaxType
from aiida_common_workflows.workflows.relax.cp2k import Cp2kRelaxInputsGenerator

StructureData = DataFactory('structure')

GENERATOR = Cp2kRelaxInputsGenerator
CALC_ENGINES = {
    'relax': {
        'code': 'cp2k@localhost',
        'options': {
