...
from aiida_common_workflows.workflows.relax.siesta.generator import SiestaRelaxInputsGenerator
InpGen = SiestaRelaxInputsGenerator()
calc_engines = {
    'relaxation': {
...
for scale in [1,1.02,1.04,1.06]: #[0.94,0.96,0.98]: #,1,1.02,1.04,1.06]:
