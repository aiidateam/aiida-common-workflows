...
# -*- coding: utf-8 -*-
"""Launch script for the common relax work chain demonstrator using CASTEP"""
...
RelaxWorkChain = WorkflowFactory('common_workflows.relax.castep')

CALC_ENGINES = {
    'relax': {
        'code': 'castep-19.1.1@localhost',
        'options': {
            'resources': {
                'num_machines': 1
            },
