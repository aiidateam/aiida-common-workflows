...
from .generator_sirius import Cp2kSiriusCommonRelaxInputGenerator

__all__ = ('Cp2kSiriusCommonRelaxWorkChain',)
...
class Cp2kSiriusCommonRelaxWorkChain(CommonRelaxWorkChain):
    """Implementation of `aiida_common_workflows.common.relax.workchain.CommonRelaxWorkChain` for CP2K.
    Modified for SIRIUS
    """
    _process_class = Cp2kBaseWorkChain
    _generator_class = Cp2kSiriusCommonRelaxInputGenerator
