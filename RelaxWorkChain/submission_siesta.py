...
assert SiestaRelGen.get_calc_type_schema('final_scf') == {
    'code_plugin': 'siesta.siesta',
    'description': 'This is the final SCF calculation that is always performed after a successful relaxation. '
...
builder = rel_workflow_gen.get_builder(
    ...
    relaxation_type=relaxation_type, threshold_forces=threshold_forces, threshold_stress=threshold_stress)
...
new_params = builder.parameters.get_dict() # Assuming that these parameters are in the expose_inputs of the WorkChain to run
